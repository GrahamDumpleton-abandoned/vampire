# The following functions have been borrowed with permission from the
# FormEncode/Validator package. The complete package is available from:
#
#   "http://formencode.org".
#
# The file originally appeared as "validator/variabledecode.py" within
# that package. The full package was originally released under the
# Python Software Foundation License and these functions should strictly
# still be deemed to be under that license.
