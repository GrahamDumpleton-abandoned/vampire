...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sun May 15 22:08:27 2005
   Source file: cached_templates.tmpl
   Source file last modified: Sun May 15 22:03:41 2005
"""

__CHEETAH_genTime__ = 'Sun May 15 22:08:27 2005'
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            write('\t<tr>\n\t<td>')
            write(filter(VFFSL(SL,"info.path",True), rawExpr='$info.path')) # from line 32, col 6.
            write('</td>\n\t<td>')
            write(filter(VFFSL(SL,"info.attribute",True), rawExpr='$info.attribute')) # from line 33, col 6.
            write('</td>\n\t<td>')
            write(filter(VFN(VFFSL(SL,"time",True),"asctime",False)(VFN(VFFSL(SL,"time",True),"localtime",False)(VFFSL(SL,"info.mtime",True))), rawExpr='$time.asctime($time.localtime($info.mtime))')) # from line 34, col 6.
            write('</td>\n\t<td>')
            write(filter(VFN(VFFSL(SL,"time",True),"asctime",False)(VFN(VFFSL(SL,"time",True),"localtime",False)(VFFSL(SL,"info.atime",True))), rawExpr='$time.asctime($time.localtime($info.atime))')) # from line 35, col 6.
            write('</td>\n\t<td>')
            write(filter(VFFSL(SL,"info.hits",True), rawExpr='$info.hits')) # from line 36, col 6.
            write('</td>\n\t</tr>\n')
        write('''</tbody>
