...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sun May 15 22:08:28 2005
   ...
   Source file last modified: Sun May 15 22:07:15 2005
"""
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            write('</td>\n\t<td>')
            write(filter(VFFSL(SL,"options",True)[VFFSL(SL,"key",True)], rawExpr='$options[$key]')) # from line 27, col 6.
            write('</td>\n\t</tr>\n')
        write('''</tbody>
...
''')
        for key in VFFSL(SL,"keys",True):
            write('\t<tr>\n\t<td>')
            write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 58, col 6.
            write('</td>\n\t<td>')
            write(filter(VFFSL(SL,"defaults",True)[VFFSL(SL,"key",True)], rawExpr='$defaults[$key]')) # from line 59, col 6.
            write('</td>\n\t</tr>\n')
        write('''</tbody>
...
''')
        ...
        for section in VFFSL(SL,"sections",True):
            ...
            write(filter(VFFSL(SL,"section",True), rawExpr='$section')) # from line 72, col 6.
            write('''</h3>
	<table>
...
''')
            ...
            for key in VFFSL(SL,"keys",True):
                write('\t\t<tr>\n\t\t<td>')
                write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 87, col 7.
                write('</td>\n\t\t<td>')
                write(filter(VFN(VFFSL(SL,"config",True),"get",False)(VFFSL(SL,"section",True),VFFSL(SL,"key",True)), rawExpr='$config.get($section,$key)')) # from line 88, col 7.
                write('</td>\n\t\t</tr>\n')
            write('''	</tbody>
	</table>
	</p>
