...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Mon May 16 21:43:01 2005
   Source file: vampire_config.tmpl
   Source file last modified: Mon May 16 21:42:47 2005
"""

__CHEETAH_genTime__ = 'Mon May 16 21:43:01 2005'
...
''')
        for key in VFFSL(SL,"keys",True):
            write('    <tr>\n    <td>')
            write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 58, col 9.
            write('</td>\n    <td>')
            write(filter(VFFSL(SL,"defaults",True)[VFFSL(SL,"key",True)], rawExpr='$defaults[$key]')) # from line 59, col 9.
            write('</td>\n    </tr>\n')
        write('''</tbody>
...
''')
        ...
        for section in VFFSL(SL,"sections",True):
            ...
            write(filter(VFFSL(SL,"section",True), rawExpr='$section')) # from line 72, col 9.
            write('''</h3>
    <table>
...
''')
            ...
            for key in VFFSL(SL,"keys",True):
                write('\t<tr>\n\t<td>')
                write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 87, col 6.
                write('</td>\n\t<td>')
                write(filter(VFN(VFFSL(SL,"config",True),"get",False)(VFFSL(SL,"section",True),VFFSL(SL,"key",True)), rawExpr='$config.get($section,$key)')) # from line 88, col 6.
                write('</td>\n\t</tr>\n')
            write('''    </tbody>
    </table>
    </p>
