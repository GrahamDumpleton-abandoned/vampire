...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sat May 14 20:26:37 2005
   Source file: vampire_config.tmpl
   Source file last modified: Sat May 14 20:26:34 2005
"""

__CHEETAH_genTime__ = 'Sat May 14 20:26:37 2005'
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            write('</td>\n<td>')
            write(filter(VFFSL(SL,"options",True)[VFFSL(SL,"key",True)], rawExpr='$options[$key]')) # from line 25, col 5.
            write('</td>\n</tr>\n')
        write('''</tbody>
</table>
</p>
...
''')
        for key in VFFSL(SL,"keys",True):
            write('<tr>\n<td>')
            write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 54, col 5.
            write('</td>\n<td>')
            write(filter(VFFSL(SL,"defaults",True)[VFFSL(SL,"key",True)], rawExpr='$defaults[$key]')) # from line 55, col 5.
            write('</td>\n</tr>\n')
        write('''</tbody>
</table>
</p>
...
''')
        ...
        for section in VFFSL(SL,"sections",True):
            ...
            write(filter(VFFSL(SL,"section",True), rawExpr='$section')) # from line 67, col 5.
            write('''</h3>
<table>
<thead>
<tr>
...
''')
            ...
            for key in VFFSL(SL,"keys",True):
                write('<tr>\n<td>')
                write(filter(VFFSL(SL,"key",True), rawExpr='$key')) # from line 80, col 5.
                write('</td>\n<td>')
                write(filter(VFN(VFFSL(SL,"config",True),"get",False)(VFFSL(SL,"section",True),VFFSL(SL,"key",True)), rawExpr='$config.get($section,$key)')) # from line 81, col 5.
                write('</td>\n')
            write('''</tr>
</tbody>
</table>
