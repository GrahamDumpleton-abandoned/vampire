...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sat May 14 16:58:14 2005
   Source file: cached_modules.tmpl
   Source file last modified: Sat May 14 16:58:00 2005
"""

__CHEETAH_genTime__ = 'Sat May 14 16:58:14 2005'
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            write('<tr>\n<td>')
            write(filter(VFFSL(SL,"info.file",True), rawExpr='$info.file')) # from line 29, col 5.
            write('</td>\n<td>')
            write(filter(VFN(VFFSL(SL,"time",True),"asctime",False)(VFN(VFFSL(SL,"time",True),"localtime",False)(VFFSL(SL,"info.mtime",True))), rawExpr='$time.asctime($time.localtime($info.mtime))')) # from line 30, col 5.
            write('</td>\n<td>')
            write(filter(VFN(VFFSL(SL,"time",True),"asctime",False)(VFN(VFFSL(SL,"time",True),"localtime",False)(VFFSL(SL,"info.atime",True))), rawExpr='$time.asctime($time.localtime($info.atime))')) # from line 31, col 5.
            write('</td>\n<td>')
            write(filter(VFFSL(SL,"info.direct",True), rawExpr='$info.direct')) # from line 32, col 5.
            write('</td>\n</tr>\n')
        write('''</tbody>
</table>
</p>
