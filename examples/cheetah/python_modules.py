...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sun May 15 19:59:47 2005
   ...
   Source file last modified: Sun May 15 19:56:28 2005
"""
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            if VFFSL(SL,"hasattr",False)(VFN(VFFSL(SL,"sys",True),"modules",True)[VFFSL(SL,"key",True)],"__file__"):
                write('    ')
                write(filter(VFN(VFN(VFFSL(SL,"sys",True),"modules",True)[VFFSL(SL,"key",True)],"__file__",True), rawExpr='$sys.modules[$key].__file__')) # from line 29, col 5.
                write('\n')
            write('    </td>\n  </tr>\n')
        write('''</tbody>
