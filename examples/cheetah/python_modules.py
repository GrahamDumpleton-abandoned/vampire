...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Mon May 16 21:42:59 2005
   ...
   Source file last modified: Mon May 16 21:42:01 2005
"""
...
''')
        for key in VFFSL(SL,"keys",True):
            ...
            if VFFSL(SL,"hasattr",False)(VFN(VFFSL(SL,"sys",True),"modules",True)[VFFSL(SL,"key",True)],"__file__"):
                write('\t')
                write(filter(VFN(VFN(VFFSL(SL,"sys",True),"modules",True)[VFFSL(SL,"key",True)],"__file__",True), rawExpr='$sys.modules[$key].__file__')) # from line 29, col 2.
                write('\n')
            write('    </td>\n    </tr>\n')
        write('''</tbody>
