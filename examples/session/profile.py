...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Sun Jun  5 21:44:38 2005
   ...
   Source file last modified: Sun Jun  5 21:24:58 2005
"""
...
<p>
Hello ''')
        write(filter(VFN(VFFSL(SL,"req",True),"session",True)["profile"]["fullname"], rawExpr='$req.session["profile"]["fullname"]')) # from line 9, col 7.
        write('''.
</p>
<p>
You are a member of the groups ''')
        write(filter(VFN(VFFSL(SL,"req",True),"session",True)["profile"]["groups"], rawExpr='$req.session["profile"]["groups"]')) # from line 12, col 32.
        write('''.
</p>
<p>
